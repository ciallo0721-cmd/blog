...
define config.version = "1.0721"


## 放置在游戏内“关于”屏幕上的文本。将文本放在三个引号之间，并在段落之间留出空
## 行。

define gui.about = _p("""防盗水印:本galgame由墨羽(别名quan)制作\n
本游戏的所有图片均出自ai绘制\n
本游戏的音乐均出自网络\n
...
游戏的主要目的是让玩家感受到生活中的小确幸和温暖。
这是一个轻松愉快的游戏，适合所有年龄段的玩家。\n
游戏的画面和音乐都很轻松愉快，希望能给玩家带来放松的体验。\n
...
define build.name = "zhomdshipian"
...
define config.save_directory = "qwertyuiop-1753620203"
