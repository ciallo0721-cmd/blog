"use strict";
/* ============================================================
   HRAI · keymap.js — 键位自定义（恐怖逃生精简版）
     A. 键盘键位：动作 → 按键，存 localStorage['hraiKeymap']
     B. 手指键位：触屏按钮位置，存 localStorage['hraiTouchLayout']
...
const KEYMAP_ORDER = ['forward','back','left','right','jump','crouch','use'];
const LS_KEYMAP = 'hraiKeymap';
...
/* ================= B. 手指键位（触屏布局） ================= */
const TOUCH_IDS = ['joystick','btnUse','btnCrouch','btnJump'];
const LS_LAYOUT = 'hraiTouchLayout';
